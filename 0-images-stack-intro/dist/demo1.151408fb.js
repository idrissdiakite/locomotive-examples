...
exports.preloadImages = exports.preloadFonts = exports.lerp = exports.getRandomInteger = exports.getMousePos = exports.calcWinsize = void 0;
...
var GalleryController = /*#__PURE__*/function () {
  ...
  _createClass(GalleryController, [{
    ...
    value: function intro() {
      ...
      timeline.addLabel('startAnimation', '+=0')
...
Promise.all([(0, _utils.preloadImages)('.gallery__item-imginner'), (0, _utils.preloadFonts)('lty4rfv')]).then(function () {
  ...
  new _galleryController.default(document.querySelector('.gallery'));
